package de.scrapebee.vectorspace;
...
public class VectorSpace {
    ...
    public void addDocument(Article article, List<String> tokens) {
        if (index.get(article.getId()) != null) {
            throw new RuntimeException("Document ID already exists: " + article.getId());
        }
        DocumentVector dv = new DocumentVector(this, article.getId());
